client: build/main.o build/game.o build/texturemanager.o build/map.o build/vector2d.o build/collision.o
	g++ -o client build/main.o build/game.o build/texturemanager.o build/map.o build/vector2d.o build/collision.o -lSDL2main -lSDL2 -lSDL2_image
